...
Version  : 5.14.3
Release  : 7
URL      : https://download.kde.org/stable/plasma/5.14.3/plasma-browser-integration-5.14.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.3/plasma-browser-integration-5.14.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.3/plasma-browser-integration-5.14.3.tar.xz.sig
...
%prep
%setup -q -n plasma-browser-integration-5.14.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1541534199
mkdir -p clr-build
pushd clr-build
%cmake ..
