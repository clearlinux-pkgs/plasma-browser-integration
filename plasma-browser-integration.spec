...
Source0  : https://download.kde.org/stable/plasma/5.14.1/plasma-browser-integration-5.14.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.1/plasma-browser-integration-5.14.1.tar.xz.sig
...
%prep
%setup -q -n plasma-browser-integration-5.14.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1539732528
mkdir -p clr-build
pushd clr-build
%cmake ..
