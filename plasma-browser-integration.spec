...
Source0  : https://download.kde.org/stable/plasma/5.15.1/plasma-browser-integration-5.15.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.15.1/plasma-browser-integration-5.15.1.tar.xz.sig
...
%prep
%setup -q -n plasma-browser-integration-5.15.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1550594378
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
