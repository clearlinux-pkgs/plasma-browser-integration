...
Version  : 5.14.2
Release  : 6
URL      : https://download.kde.org/stable/plasma/5.14.2/plasma-browser-integration-5.14.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.2/plasma-browser-integration-5.14.2.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.2/plasma-browser-integration-5.14.2.tar.xz.sig
...
%prep
%setup -q -n plasma-browser-integration-5.14.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1540472081
mkdir -p clr-build
pushd clr-build
%cmake ..
