...
Source0  : https://download.kde.org/stable/plasma/5.14.0/plasma-browser-integration-5.14.0.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.0/plasma-browser-integration-5.14.0.tar.xz.sig
...
%prep
%setup -q -n plasma-browser-integration-5.14.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1539117334
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
