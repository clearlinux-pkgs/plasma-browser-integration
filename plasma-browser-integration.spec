...
Source0  : https://download.kde.org/stable/plasma/5.27.10/plasma-browser-integration-5.27.10.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.10/plasma-browser-integration-5.27.10.tar.xz.sig
...
%prep
%setup -q -n plasma-browser-integration-5.27.10
cd %{_builddir}/plasma-browser-integration-5.27.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703119830
mkdir -p clr-build
pushd clr-build
